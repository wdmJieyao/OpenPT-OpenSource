package fun.hzaw.trackerservice.pojo.po;
...
/**
 * @program: OpenPT
 * @description: Tracker Announce PO
 * Announce请求参数
 * <p>
 * 参考
...
@NoArgsConstructor
@ToString
public class AnnounceRequestPo {
     ...
     * 汇报时间
     */
    private LocalDateTime announceDateTime;


    public boolean isNoPeerId() {
        return Integer.valueOf(1).equals(getNo_peer_id());
    ...
    public boolean isCompact(){
        return Integer.valueOf(1).equals(getCompact());
    }

    // 正式使用需要用passKey + infoHashHex 去重
    // @Override
    // public boolean equals(Object o) {
    //     if (this == o) return true;
    //     if (o == null || getClass() != o.getClass()) return false;
    //     AnnounceRequestPo that = (AnnounceRequestPo) o;
    //     return Objects.equals(passkey, that.passkey) && Objects.equals(infoHashHex, that.infoHashHex);
    // }
    //
    // @Override
    // public int hashCode() {
    //     return Objects.hash(passkey, infoHashHex);
    // }
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass()) return false;
        AnnounceRequestPo that = (AnnounceRequestPo) o;
        return Objects.equals(infoHashHex, that.infoHashHex) && Objects.equals(peerIdHex, that.peerIdHex);
    }

    @Override
    public int hashCode() {
        return Objects.hash(infoHashHex, peerIdHex);
    }
}
